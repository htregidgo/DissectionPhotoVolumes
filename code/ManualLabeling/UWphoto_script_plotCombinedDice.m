...
saveas(h_soft,fullfile(output_dir,'soft_diceScores_combined_box.fig'))
saveas(h_soft,fullfile(output_dir,'soft_diceScores_combined_box.png'))

saveas(h_hard,fullfile(output_dir,'hard_diceScores_combined_box.fig'))
saveas(h_hard,fullfile(output_dir,'hard_diceScores_combined_box.png'))
